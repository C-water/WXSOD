python Test.py \
--name='WFANet' \
--pth='Net_epoch_50.pth' \
--save_path=WFANet \
--image_size=384 \
--test_set='real/' \
--image_test_dir='/data0/chenquan/WX_SOD_1222/Datasets/WXSDO_data/test_real/input/' \
--image_test_ext='.jpg' \
--gpu_ids='2'
...
#--image_test_dir='./Datasets/Dataset_real_10_23/dark/RGB/' \
#--image_test_dir='./Datasets/test/Images/' \